...
export default function AddFavoriteForm() {
  ...
  return (
    <form onSubmit={handleSubmit} class="space-x-2 mb-4">
      ...
      <input value={url} onChange={e => setUrl(e.target.value)} placeholder="链接" class="border p-1 rounded-lg border-gray-300 focus:outline-none focus:border-violet-500"/>
      <input value={tag} onChange={e => setTag(e.target.value)} placeholder="分类(可选)" class="border p-1 rounded-lg border-gray-300 focus:outline-none focus:border-violet-500"/>
